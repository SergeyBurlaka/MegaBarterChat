...
import static com.dreambim.megabarter.megabarterchat.ChatListFragment.USERS_CHILD;
...
public class EmailPasswordActivity extends BaseActivity implements
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        Log.d(TAG, "createUser: uName" + uName + " ");
    ...
    public void goMainScreen() {this.startActivity(new Intent(this, MainActivity.class)); this.finish();}
